...
void SimpleShapeApplication::init()
{
    ...
    std::vector<GLfloat> vertices = {
        ...
        // doble middle for sharp red green transition no interpolation between
        // preaty low cost only 2 more vertices instead of 2nd vertex array with the same all 7 indecies additional trainagle can be cated form randering via indexes array
